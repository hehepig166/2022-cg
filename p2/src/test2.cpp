...
struct Circle {
    ...
    Circle(): R(.5), X_SEG(20), Y_SEG(20) {Init();}
};
...
int main()
{
    ...
    Shader shader("resources/2.vs", "resources/2.fs");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // set light
        glm::vec3 light = glm::vec3(std::sin(glfwGetTime())/1.414f, std::cos(glfwGetTime())/1.414f, 1.0f/1.414f);
